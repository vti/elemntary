...
- [Windows](https://github.com/vti/elemntary/releases/download/v0.5.2/elemntary-win32-x64-0.5.2.zip) (application is not signed, you might need to add a security exception)
- [MacOS](https://github.com/vti/elemntary/releases/download/v0.5.2/elemntary-darwin-x64-0.5.2.zip) (application is not signed, you might need to add a security exception)
- [Linux](https://github.com/vti/elemntary/releases/download/v0.5.2/elemntary-linux-x64-0.5.2.zip)
